...
@Component({
  selector: 'app-confirmacion-bundle',
  standalone: true,
  imports: [
    FormsModule,
  ...
  templateUrl: './confirmacion-bundle.component.html',
  styleUrl: './confirmacion-bundle.component.css'
})
export class ConfirmacionBundleComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private validacionBundlesService: ValidacionBundlesService,
