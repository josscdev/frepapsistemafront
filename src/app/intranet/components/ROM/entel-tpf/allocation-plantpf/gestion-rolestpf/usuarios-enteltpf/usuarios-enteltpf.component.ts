...
import { EditarUsuariosEnteltpfComponent } from './editar-usuarios-enteltpf/editar-usuarios-enteltpf.component';
import { AllocationtpfService } from '../../../../../../services/entel-tpf/allocationtpf/allocationtpf.service';
import { MatDialog } from '@angular/material/dialog';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-usuarios-enteltpf',
  standalone: true,
  imports: [CommonModule,
        MatPaginatorModule,
        ReactiveFormsModule,
        FormsModule],
  templateUrl: './usuarios-enteltpf.component.html',
  styleUrl: './usuarios-enteltpf.component.css'
})
export class UsuariosEnteltpfComponent {
 readonly dialog = inject(MatDialog);
  ...
  ngOnInit(): void {
    ...
    openEdit(usuario: any): void {
      const dialogRefedit = this.dialog.open(EditarUsuariosEnteltpfComponent, {
  ...
  downloadExcel() {
    ...
    link.href = 'assets/documents/excel/formatoUsuariosEntelRombiTPF.xlsx';
    link.download = 'formatoUsuariosEntelRombiTPF.xlsx';
    link.click();
  }
