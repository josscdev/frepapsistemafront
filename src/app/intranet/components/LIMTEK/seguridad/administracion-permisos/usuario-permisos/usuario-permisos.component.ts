...
import { Item, Module, Submodule } from '../../../../../models/limtek/seguridad/modulospermisos';
import { AllUsersResponse } from '../../../../../models/limtek/seguridad/allusers';
...
export class UsuarioPermisosComponent {
  ...
  constructor(
    private permisosservice: PermisosLimtekService,
    private authService: AuthService,
    private dataSharingService: DatasharingLimtekService
  ) {
