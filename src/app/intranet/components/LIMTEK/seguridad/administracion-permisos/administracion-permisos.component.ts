...
import { CodigosRequest, CodigosResponse, Cuenta, Negocio } from '../../../../models/limtek/seguridad/codigo';
import { AllUsersRequest, AllUsersResponse } from '../../../../models/limtek/seguridad/allusers';
import { PermisosLimtekService } from '../../../../services/limtek/seguridad/permisos/permisos-limtek.service';
import { DatasharingLimtekService } from '../../../../services/limtek/seguridad/datasharing-limtek.service';
...
export class AdministracionPermisosComponent {
  ...
  constructor(
    private permisoslimtekservice: PermisosLimtekService,
    private paginatorIntl: MatPaginatorIntl,
    private dataSharingLimtekService: DatasharingLimtekService,
      ...
      next: (response) => {
        ...
        if (empresaEncontrada) {
          ...
          if (this.idempresa === 1) {
            ...
            this.imgEmpresa = 'assets/img/Limtek/logo_limtek.svg';
          }
        } else {
  ...
  onRowClick(item: any) {
    this.dataSharingLimtekService.setSelectedItem(item);
  ...
  loadCodigos() {
    ...
    this.permisoslimtekservice.getCodigos(request).subscribe((data: any[]) => {
      this.codigos = data;
  ...
  getAllUsers() {
    ...
    this.permisoslimtekservice.getAllUsers(this.allUsersRequest).subscribe(data => {
      this.allUsers = [];
