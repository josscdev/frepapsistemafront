...
import { Bundletpf, Modelotpf, Operadortpf, Planestpf, Subproductotpf, TipoAccesoriotpf, TipoEquipotpf, TipoEtiquetatpf, TipoPagotpf, TipoSegurotpf } from '../../../../../../../models/entel-tpf/ventastpf/listasVentastpf';
import { VentastpfService } from '../../../../../../../services/entel-tpf/ventastpf/ventastpf.service';
import Swal from 'sweetalert2';
import { VentasDetalletpf } from '../../../../../../../models/entel-tpf/ventastpf/ventastpf';
...
@Component({
  ...
  templateUrl: './editar-ventatpf.component.html',
  styleUrl: './editar-ventatpf.component.css'
})
export class EditarVentatpfComponent {
  readonly dialogRef = inject(MatDialogRef<EditarVentatpfComponent>);
  editForm: FormGroup;
  ...
  saveEditVenta() {
    ...
    const request: VentasDetalletpf = {
    ...
    this.ventastpfService.updateVentasDetalle(request).subscribe(res => {
