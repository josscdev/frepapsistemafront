...
@Component({
  selector: 'app-asignacion-turnos-pdvtpf',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './asignacion-turnos-pdvtpf.component.html',
  styleUrl: './asignacion-turnos-pdvtpf.component.css'
})
export class AsignacionTurnosPDVtpfComponent implements OnInit {
